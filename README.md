...
Для запуска программы должен быть установлен Python. Также необходимо скачать ffmpeg (https://ffmpeg.org/download.html) - набор библиотек для обработки звука, эти быблиотеки использует библиотека pydub Питона.
